...
public class GhostHunterAI extends AdvancedCombatAI {
   ...
   public List<OffensiveSpell> getOffensiveSpells() {
      ...
      _offensiveSpells.add(new OffensiveSpell(410, 2));
      _offensiveSpells.add(new OffensiveSpell(321, 2));
      _offensiveSpells.add(new OffensiveSpell(358, 3));
      _offensiveSpells.add(new OffensiveSpell(122, 4));
      _offensiveSpells.add(new OffensiveSpell(11, 5));
   ...
   protected List<SupportSpell> getSelfSupportSpells() {
      ...
      _selfSupportSpells.add(new SupportSpell(447, SpellUsageCondition.LESSHPPERCENT, 80, 1));
