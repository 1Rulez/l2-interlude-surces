...
public class CTF implements EventTask
{
	...
	public static boolean startJoin()
	{
		...
		if (FakePlayerConfig.ALLOW_FAKE_PLAYER_CTF && FakePlayerConfig.isAutomatedFakePopulationEnabled())
		{
	...
	public static void finishEvent()
	{
		...
		_started = false;
		_aborted = false;
		CaptureTheFlagAI.unspawnPhantoms();
		unspawnEventNpc();
	...
	private static boolean addPlayerOk(final String teamName, final Player eventPlayer)
	{
		...
		{
			eventPlayer.sendMessage("You cannot register for CTF while your clan is participating in an active siege.");
			return false;
		}
