...
public class SelectorHelper implements IMMOExecutor<L2LoginClient>, IClientFactory<L2LoginClient>, IAcceptFilter
{
	...
	public boolean accept(final SocketChannel sc)
	{
		...
		boolean ipv4Result = _ipv4filter.accept(sc);
		boolean bannedResult = !LoginController.getInstance().isBannedAddress(sc.socket().getInetAddress());
		return ipv4Result && bannedResult;
	}
