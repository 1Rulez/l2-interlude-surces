...
import com.l2jmega.gameserver.handler.itemhandlers.custom.TimedItemHandler;
import com.l2jmega.gameserver.handler.itemhandlers.custom.RemoveSkin;
...
public class ItemHandler
{
	...
	protected ItemHandler()
	{
		...
		registerItemHandler(new RemoveSkin());
		...
		registerItemHandler(new TimedItemHandler());
