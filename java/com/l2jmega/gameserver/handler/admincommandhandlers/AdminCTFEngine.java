...
public class AdminCTFEngine implements IAdminCommandHandler
{
	...
	public boolean useAdminCommand(final String command, final Player activeChar)
	{
		...
		final AdminCTFCommand comm;
		try
		{
			comm = AdminCTFCommand.valueOf(st.nextToken());
		}
	...
	public void showControlPage(final Player activeChar)
	{
		...
		replyMSG.append("</tr></table><table><tr>");
		replyMSG.append("<table border=\"0\"><tr>");
		replyMSG.append("<td width=\"100\"><button value=\"Full Start\" action=\"bypass -h admin_ctf_startevent\" width=90 height=15 back=\"sek.cbui94\" fore=\"sek.cbui92\"></td>");
		replyMSG.append("</tr></table><table><tr>");
		...
		replyMSG.append("</tr></table><br>");
		replyMSG.append("<center><font color=\"LEVEL\">Full Start runs Join -> Teleport -> Start automatically.</font></center><br>");
		replyMSG.append("<br><center><button value=\"Back\" action=\"bypass -h admin_ctf\" width=90 height=15 back=\"sek.cbui94\" fore=\"sek.cbui92\"></center></body></html>");
		adminReply.setHtml(replyMSG.toString());
		activeChar.sendPacket(adminReply);
	}
