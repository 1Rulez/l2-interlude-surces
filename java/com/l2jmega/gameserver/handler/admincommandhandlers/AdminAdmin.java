...
public class AdminAdmin implements IAdminCommandHandler
{
	...
	public boolean useAdminCommand(String command, Player activeChar)
	{
				...
				do
				{
					...
					//Reload Icons
					 else if (type.startsWith("icons"))
		                {
							...
							IconTable.load();
		                    activeChar.sendMessage("Icons XML have been reloaded.");
		                }
		...
		else if (command.equals("admin_testskin"))
		{
			// Test skin system
		...
		else if (command.equals("admin_removeskin"))
		{
			// Remove current skin
			if (activeChar.getDress() == null)
			{
				activeChar.sendMessage("You are not wearing any skin.");
			}
			else
			{
				activeChar.setDress(null);
				activeChar.broadcastUserInfo();
				activeChar.sendMessage("Skin removed successfully!");
			}
		}
		return true;
	}
