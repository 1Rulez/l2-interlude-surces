...
import com.l2jmega.gameserver.handler.voicedcommandhandlers.AnonymousPvPVoiced;
...
import com.l2jmega.gameserver.handler.voicedcommandhandlers.VoicedRobots;
...
import Base.RandomFightEvent.RandomFightVoiced;
...
public class VoicedCommandHandler
{
	...
	protected VoicedCommandHandler()
	{
		...
		registerHandler(new VoicedRobots());
		...
		registerHandler(new RandomFightVoiced());
		registerHandler(new AnonymousPvPVoiced());
	}
