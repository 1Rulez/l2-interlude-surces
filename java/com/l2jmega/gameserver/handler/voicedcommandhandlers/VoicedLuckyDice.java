...
public class VoicedLuckyDice implements IVoicedCommandHandler
{
	...
	public boolean useVoicedCommand(String command, Player player, String target)
	{
		...
		else if (command.startsWith("play1"))
      {
        ...
        try
        {
          ...
          if(type.startsWith("TvTCoin"))
          {
        	  _itemId = 9501;
          }
          else if(type.startsWith("AncientAd"))
          {
        	  _itemId = 5575;
          }
          else if(type.startsWith("PartyCoin"))
          {
        	  _itemId = 9546;
          }
    ...
    private static String casinoWindow(Player player)
    {
        ...
        tb.append("<html imgsrc=\"sek.cbui325\"><center><title>Lucky Dice</title><img src=\"L2COBA_GUI.L2COBA_Logo-m\" width=\"300\" height=\"177\"></center><body><center>");
        ...
        tb.append("<tr><td align=\"center\"><font color=\"0F92FF\">EN:Jackpot: TvT Coin: "+jackpot+"</font></td></tr>");	
        tb.append("<tr><td align=\"center\"><font color=\"0F92FF\">EN:Jackpot: Ancient Adena: "+jackpot2+"</font></td></tr><br>"); 
        tb.append("<tr><td align=\"center\"><font color=\"0F92FF\">EN:Jackpot: Party Coin: "+jackpot3+"</font></td></tr>"); 
        tb.append("<tr></tr>");
        tb.append("</table>");
        tb.append("<table width=300>");
        tb.append("<tr>");
        ...
        tb.append("<tr><td align=\"center\"><font color=\"0F92FF\">PT:Item Acumulado: TvT Coin: "+jackpot+"</font></td></tr>");	
        tb.append("<tr><td align=\"center\"><font color=\"0F92FF\">PT:Item Acumulado: Ancient Adena: "+jackpot2+"</font></td></tr>"); 
        tb.append("<tr><td align=\"center\"><font color=\"0F92FF\">PT:Item Acumulado: Party Coin: "+jackpot3+"</font></td></tr>"); 
        tb.append("<tr></tr>");
        tb.append("</table>");
        ...
        tb.append("<td><combobox width=120 height=21 var=\"cb\"list=TvTCoin;AncientAd;PartyCoin></td>");
        tb.append("</tr>");
        tb.append("<tr></tr>");
        tb.append("<tr></tr>");
        tb.append("<tr>");
