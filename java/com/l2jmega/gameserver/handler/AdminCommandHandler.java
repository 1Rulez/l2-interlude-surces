...
import com.l2jmega.gameserver.handler.admincommandhandlers.AdminAnonymousPvP;
...
import com.l2jmega.gameserver.handler.admincommandhandlers.AdminBossEvent;
...
import com.l2jmega.gameserver.handler.admincommandhandlers.AdminFakePlayers;
...
import com.l2jmega.gameserver.handler.admincommandhandlers.AdminRandomFight;
...
public class AdminCommandHandler
{
	...
	protected AdminCommandHandler()
	{
		...
		registerAdminCommandHandler(new AdminRacesOnWar());
		registerAdminCommandHandler(new AdminRandomFight());
		registerAdminCommandHandler(new AdminBossEvent());
		registerAdminCommandHandler(new AdminAnonymousPvP());
	}
