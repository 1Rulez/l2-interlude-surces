...
public class UserInfo extends L2GameServerPacket
{
	...
	protected final void writeImpl()
	{
		...
		// With subclass, first class id drives the local paperdoll mesh; keep base for non-GM subs (see getAppearanceClassId).
		...
		// Real active class so status window / subclass switch still refresh when this value changes.
