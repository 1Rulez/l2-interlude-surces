...
public class Die extends L2GameServerPacket
{
	...
	public Die(Creature cha)
	{
		...
		if (cha instanceof Player)
		{
			...
			_canTeleport = !(player.isInsideZone(ZoneId.ELYSIAN_ULTIMATE) && L2ElysianUltimateZone.revive);
	...
	protected final void writeImpl()
	{
		...
		writeC(0x06);
		writeD(_charObjId);
		writeD(_canEvent && _canTeleport  ? 0x01 : 0); // 6d 00 00 00 00 - to nearest village
		
		if (_canEvent && _canTeleport && _clan != null)
		{
			SiegeSide side = null;
