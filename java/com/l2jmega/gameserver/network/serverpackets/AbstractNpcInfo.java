...
public abstract class AbstractNpcInfo extends L2GameServerPacket
{
	...
	public static class NpcInfo extends AbstractNpcInfo
	{
		...
		public NpcInfo(Npc cha, Creature attacker)
		{
			...
			if (Config.SHOW_NPC_LVL && _npc instanceof Monster && !(_npc.getNpcId() == Config.monsterId) && !(Config.LIST_NPC_CUSTOM_MONSTER_Tyra.contains(Integer.valueOf(_npc.getNpcId()))) && !(Config.LIST_NPC_CUSTOM_MONSTER_Champion.contains(Integer.valueOf(_npc.getNpcId()))) && !(Config.LIST_NPC_CUSTOM_MONSTER.contains(Integer.valueOf(_npc.getNpcId()))) && !(_npc instanceof RaidBoss) && !(_npc instanceof GrandBoss))
			...
			if (Config.LIST_NPC_CUSTOM_MONSTER_Champion.contains(Integer.valueOf(_npc.getNpcId())) && _npc.isChampion())
				_title = "Champion*" + Config.TITLE_MONSTER_SOLO_Champion;
			else if (Config.LIST_NPC_CUSTOM_MONSTER_Champion.contains(Integer.valueOf(_npc.getNpcId())))
			    _title = Config.TITLE_MONSTER_SOLO_Champion;
			//----------------------------------------
			//  New Test Mod Drops champ End Code
			//----------------------------------------
			
			//----------------------------------------
			//  New Test Mod Drops tyra
			//----------------------------------------
			
			if (Config.LIST_NPC_CUSTOM_MONSTER_Tyra.contains(Integer.valueOf(_npc.getNpcId())) && _npc.isChampion())
				_title = "Champion*" + Config.TITLE_MONSTER_SOLO_Tyra;
			else if (Config.LIST_NPC_CUSTOM_MONSTER_Tyra.contains(Integer.valueOf(_npc.getNpcId())))
			    _title = Config.TITLE_MONSTER_SOLO_Tyra;
			//----------------------------------------
			//  New Test Mod Drops tyra End Code
			//----------------------------------------
			...
			// Custom clan crest system for Clan Stronghold Device
			else if (Config.SHOW_NPC_CREST && _npc.getCustomClanId() != 0)
			{
				_clanCrest = _npc.getCustomClanCrestId();
				_clanId = _npc.getCustomClanId();
				_allyCrest = _npc.getCustomAllyCrestId();
				_allyId = _npc.getCustomAllyId();
			}
		}
