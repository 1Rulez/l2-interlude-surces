...
public class MailBBSManager extends BaseBBSManager
{
    ...
    private static final String CREATE_TABLE_IF_NOT_EXISTS =
        ...
        "recipientNames VARCHAR(128) NOT NULL, " +
	...
	private void initId()
	{
		...
		{
            // Ensure table exists to avoid SQLSyntaxErrorException on first run
            try (PreparedStatement create = con.prepareStatement(CREATE_TABLE_IF_NOT_EXISTS))
            {
                create.execute();
            }
