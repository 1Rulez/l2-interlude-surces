	   ...
	   public boolean isEnchanted16(Player player)
	    {
	        ...
	        if(chestItem.getEnchantLevel() < 30)
	            return false;
	        if (legsItem != null && legsItem.getEnchantLevel() > 30)
	            return false;
	        if (glovesItem != null && glovesItem.getEnchantLevel() > 30)
	            return false;
	        if (headItem != null && headItem.getEnchantLevel() > 30)
	            return false;
	        if (feetItem != null && feetItem.getEnchantLevel() > 30)
	            return false;
