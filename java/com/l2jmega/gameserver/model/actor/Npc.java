...
public class Npc extends Creature
{
	...
	// Clan Stronghold Device fields
	private int _customClanId = 0;
	private int _customClanCrestId = 0;
	private int _customAllyCrestId = 0;
	private int _customAllyId = 0;
	...
	// Clan Stronghold Device methods
	public int getCustomClanId()
	{
		return _customClanId;
	}
	
	public void setCustomClanId(int clanId)
	{
		_customClanId = clanId;
	}
	
	public int getCustomClanCrestId()
	{
		return _customClanCrestId;
	}
	
	public void setCustomClanCrestId(int crestId)
	{
		_customClanCrestId = crestId;
	}
	
	public int getCustomAllyCrestId()
	{
		return _customAllyCrestId;
	}
	
	public void setCustomAllyCrestId(int allyCrestId)
	{
		_customAllyCrestId = allyCrestId;
	}
	
	public int getCustomAllyId()
	{
		return _customAllyId;
	}
	
	public void setCustomAllyId(int allyId)
	{
		_customAllyId = allyId;
	}
	...
	public void onBypassFeedback(Player player, String command)
	{
		...
		else if (command.startsWith("clanstronghold"))
		{
			// Handle Clan Stronghold Device commands
			String event = "";
			try
			{
				event = command.substring(14).trim(); // "clanstronghold capture" -> "capture"
			}
			catch (IndexOutOfBoundsException ioobe)
			{
			}
			
			// Find ClanStrongholdDevice script and call onAdvEvent
			Quest quest = ScriptManager.getInstance().getQuest("ClanStrongholdDevice");
			if (quest != null && event.length() > 0)
			{
				quest.notifyEvent(event, this, player);
			}
		}
	}
