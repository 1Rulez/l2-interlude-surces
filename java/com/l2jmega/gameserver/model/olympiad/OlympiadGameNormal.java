...
abstract public class OlympiadGameNormal extends AbstractOlympiadGame
{
	...
	protected final boolean makeCompetitionStart()
	{
		...
		_playerOne.player.getAppearance().setVisible();
		_playerTwo.player.getAppearance().setVisible();
		_playerOne.player.setIsInvul(false);
		_playerTwo.player.setIsInvul(false);
		if (_playerOne.player.isSpawnProtected())
			_playerOne.player.setSpawnProtection(false);
		if (_playerTwo.player.isSpawnProtected())
			_playerTwo.player.setSpawnProtection(false);
		_playerOne.player.setOlympiadProtection(false);
		_playerTwo.player.setOlympiadProtection(false);
		_playerOne.player.setStopArena(false);
		_playerTwo.player.setStopArena(false);
		_playerOne.player.broadcastUserInfo();
		_playerTwo.player.broadcastUserInfo();
		OlympiadFakeSystem.getInstance().onOlympiadStart(Arrays.asList(_playerOne.player, _playerTwo.player));
	...
	{
		OlympiadFakeSystem.getInstance().clearActiveFakes(Arrays.asList(_playerOne.player, _playerTwo.player));
