...
public class L2SiegeZone extends L2SpawnZone
{
	...
	protected void onExit(Creature character)
	{
		...
		if (character instanceof Player)
		{
			...
			// Keep siege participant state while the siege is still active.
			// Attackers can legitimately move and rally outside the polygon before re-entering.
			if (!_isActiveSiege || activeChar.getSiegeState() <= 0)
