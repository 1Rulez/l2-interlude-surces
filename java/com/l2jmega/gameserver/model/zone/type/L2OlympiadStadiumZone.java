...
public class L2OlympiadStadiumZone extends L2SpawnZone
{
	...
	{
		final L2GameServerPacket packet = new ExOlympiadUserInfo(player);
	...
	{
		return player != null && !player.isInObserverMode() && player.isInOlympiadMode() && _task != null && _task.isBattleStarted() && _task.getGame() != null && player.getOlympiadGameId() == _task.getGame().getStadiumId();
	}
